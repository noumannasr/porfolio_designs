            ...
            Padding(
              ...
              child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                  maxCrossAxisExtent:
                  140.0, // Set the maximum width for each item
                  mainAxisSpacing: 8.0,
          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                        ...
                        index == 4 ?
                        [
                          Color(0xFF63AEF7).withOpacity(0.5),
                          Color(0xFF63AEF7),
                        ...
                        [
                          ...
                          Color(0xFFE88E1D).withOpacity(0.5),
                          Color(0xFFE88E1D),
                        ]
                ...
                child: IconButton(
                  icon:
                  index == 0 ? FaIcon(FontAwesomeIcons.chartPie, color: Colors.white,) :
                  index == 1 ? FaIcon(FontAwesomeIcons.solidFileLines, color: Colors.white,) :
                  index == 2 ? FaIcon(FontAwesomeIcons.circleInfo, color: Colors.white,) :
                  index == 3 ? FaIcon(FontAwesomeIcons.solidAddressCard, color: Colors.white,) :
                  index == 4 ? FaIcon(FontAwesomeIcons.buildingLock, color: Colors.white,) :
                  FaIcon(FontAwesomeIcons.solidAddressBook, color: Colors.white,)
            ...
            Center(
                child: Padding(
                  ...
                  child: Text(
                    title.toUpperCase(),
                    style: TextStyle(color: Color(0xFF364B5F), fontSize: 12, fontWeight: FontWeight.w500),
